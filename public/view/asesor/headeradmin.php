    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side-nav">
            ...
            <ul class="list-unstyled px-2 text-white">
                ...
                <li class=""><a class="px-1 text-decoration-none d-block nav-link" href="especialidad.php"><i class="fa-solid fa-user-doctor px-3 py-2"></i>Especialidad</a></li>
                <li class=""><a class="px-1 text-decoration-none d-block nav-link" href="sede.php"><i class="fa-solid fa-house-building px-3 py-2"></i>Sede</a></li>
            </ul>
