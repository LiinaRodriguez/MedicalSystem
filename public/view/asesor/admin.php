    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side-nav">
            ...
            <ul class="list-unstyled px-2 text-white">
                <li class="active"><a class="px-1 text-decoration-none d-block nav-link" href="admin.php"><i
                            class="fa-solid fa-house px-3 py-2"></i>Inicio</a></li>
                <li class=""><a class="px-1 text-decoration-none d-block nav-link" href="admin_citas.php"><i
                ...
                <li class=""><a class="px-1 text-decoration-none d-block nav-link" href="admin_medico.php"><i
